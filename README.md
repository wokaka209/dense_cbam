...
## Ablation Study Configuration ����ʵ������

����Ŀʵ��������������ʵ�鹦�ܣ�֧�ֶ�CBAMע�������ơ��ںϲ��Ժ���ʧ��������ģ�黯���ã������о��߽��������Ч�Է�����

### 1. CBAMע������������ʵ��

ͨ����������ͨ��ע�����Ϳռ�ע���������Է���CBAM�������ģ�����ܵ�Ӱ�졣

#### ���ò���

| ������ | ���� | Ĭ��ֵ | ˵�� |
|--------|------|--------|------|
| --use_channel_attention | ool | True | �Ƿ�����ͨ��ע����ģ�� |
| --use_spatial_attention | ool | True | �Ƿ����ÿռ�ע����ģ�� |
...
��ģ�ʹ����У�CBAMģ���Ѹ���Ϊ֧�ֶ������ƣ�
- ��use_channel_attention=Falseʱ������ͨ��ע��������
- ��use_spatial_attention=Falseʱ�������ռ�ע��������
- ���߾�ΪFalseʱ��CBAMģ���˻�Ϊ���ӳ��

### 2. �ںϲ�������ʵ��

֧�����ֲ�ͬ���ںϲ��ԣ������ڷ�����ͬ�ںϷ������ں�������Ӱ�졣

#### ���ò���

| ������ | ���� | Ĭ��ֵ | ��ѡֵ | ˵�� |
|--------|------|--------|--------|------|
| --fusion_strategy | str | dd | dd, l1norm, hybrid | �ںϲ���ѡ�� |

#### ����˵��

1. **add��ƽ���ںϣ�**: (ir_features + vi_features) / 2
   - �ŵ㣺����򵥣��ȶ��Ը�
   - ���ó��������߶Ա�

2. **l1norm��L1������Ȩ�ںϣ�**: ��������L1����������Ӧ��Ȩ�ں�
   - �ŵ㣺����ӦȨ�أ�ͻ����Ҫ����
   - ���ó�������Ҫ����ѡ�������

3. **hybrid������ںϣ�**: ���add��l1norm���ŵ�
   - �ŵ㣺ƽ���ȶ��Ժ�����ѡ����
   - ���ó�����׷������ں�����
...
ͨ�������ݶȷ��򣬿��Է���ˮƽ�ݶȺʹ�ֱ�ݶȶ���ʧ������Ӱ�졣

#### ���ò���

| ������ | ���� | Ĭ��ֵ | ��ѡֵ | ˵�� |
|--------|------|--------|--------|------|
| --gradient_direction | str | idirectional | single, idirectional | �ݶȷ���ѡ�� |

#### ����˵��

1. **single��������**: ��ʹ��ˮƽ�ݶȣ�alpha=1.0, beta=0.0��
   - �ŵ㣺���������룬�ʺϱ�Ե��Ҫ��ˮƽ�����ͼ��
   - ���ó���������ˮƽ�ݶȵ���Ҫ��

2. **bidirectional��˫��**: ʹ��ˮƽ�ʹ�ֱ�ݶȣ�Ĭ��alpha=1.0, beta=1.0��
   - �ŵ㣺ȫ�沶׽ͼ���Ե��Ϣ
   - ���ó�������׼���ã�׷���������
...
- **CBAM����**: models/attention_modules.py�е�CBAM��ColorAwareCBAM��
- **�ںϲ���**: models/DenseFuse.py�е�pply_fusion_strategy����
- **�ݶȷ���**: 	rain_ir_vi_optimized.py�е��ݶ���ʧ�����߼�
- **��������**: 	rain_ir_vi_optimized.py�е�parse_args����

ͨ����������ʵ�����ã��о��߿���ϵͳ�ط����������ģ�����ܵĹ��ף�Ϊģ���Ż��ṩ����֧�֡�
